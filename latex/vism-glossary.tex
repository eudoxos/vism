...
\par\textbf{*atisāra} flux (of bowels), diarrhoea: \hyperlink{XI.21}{XI.21}{} atīta-past 
...
\par\textbf{adosa} non-hate addhā, addhāna—extent, period
...
\par\textbf{ānantarika} (kamma) with immediate 
\par\textbf{[???]} result (on rebirth)
...
\par\textbf{ārammaṇa} object (of consciousness or 
\par\textbf{[???]} its concomitants), support
...
\par\textbf{utu-samuṭṭhāna} temperature-originated 
\par\textbf{[???]} (matter)
...
\par\textbf{*upanayana} \emph{also }applying (log.), induc
\par\textbf{[???]} ing, leading on: \hyperlink{VII.83}{VII.83}{}; \hyperlink{XIV.68}{XIV.68}{}
...
\par\textbf{nissaya} (1) support, (2) the dependence 
\par\textbf{[???]} (given by teacher to pupil) 
...
\par\textbf{pakati} (1) nature, natural, normal, (2) 
\par\textbf{[???]} Primordial Essence, Prakṛti
...
\par\textbf{*pabhuti} encl.) and so on, etcetera ( = ādi in that sense): \hyperlink{VIII.17}{VIII.17}{}, \hyperlink{VIII.121}{121}{}; \hyperlink{X.51}{X.51}{}, etc. 
...
\par\textbf{pāpicchatā} evilness of wishes pāramī, pāramitā—perfection
...
\par\textbf{puthujjana} ordinary man (i.e. one who has not 
\par\textbf{[???]} reached the path)
...
\par\textbf{bodhisatta} Bodhisatta, Being Destined 
\par\textbf{[???]} to Enlightenment
...
\par\textbf{*bheda, vacī- } speech utterance: \hyperlink{XIV.62}{XIV.62}{} (cf. Dhs-a 90; \textbf{\cite{M} I 301}) 
\par\textbf{magga} path macchariya, macchera—avarice 
...
\par\textbf{yoniso} wise, wisely, with ordered rea
\par\textbf{[???]} soning
...
\par\textbf{vikkhambhana} suppression (of defile
\par\textbf{[???]} ments by serenity)
...
\par\textbf{vihāra} (1) dwelling place, abode, (2) 
\par\textbf{[???]} monastery, (3) mode of abiding
...
\par\textbf{*vyāpāra} \emph{also }interest, interestedness: 
\par\textbf{[???]} \hyperlink{XVII.309}{XVII.309}{}; \hyperlink{XVIII.31}{XVIII.31}{}
...
\par\textbf{*saṅgahīta} \emph{also }heldtogether:\hyperlink{XI.90}{XI.90}{}
\par\textbf{saṅgha} theOrder,theCommunity
\par\textbf{saṅghaṭṭana} knockingtogether, impingement 
...
\par\textbf{saññāvedayitanirodha} cessation of per
\par\textbf{[???]} ception and feeling
...
\par\textbf{sa-sambhāra-kathā} “accessory locu
\par\textbf{[???]} tion” (log.)
...
\par\textbf{sukha} pleasure, pleasant, bliss, blissful, 
\par\textbf{[???]} bodily pleasure
\par\textbf{*sukha} tepid: \hyperlink{X.52}{X.52}{}
\par\textbf{*sukhana} act of pleasing: \hyperlink{IV.100}{IV.100}{}
\par\textbf{sugata} Sublime One (the Buddha) suñña, suññata—void 
...
\par\textbf{somanassa} joy, mental pleasure hadaya—heart hadaya-vatthu—heart-basis (physical 
\end{multicols}