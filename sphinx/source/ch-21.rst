...
`§1 <https://github.com/eudoxos/vism/issues/new?title=issue%20at%20XIX.1&body=(in%20version%205e05fa4%20dated%202023-02-24)>`__ *[621/679]*  ``598``  Knowledge established by overcoming doubt about the three divisions of time by means of discerning the conditions of that same mentality-materiality is called “purification by overcoming doubt.”
...
`§13 <https://github.com/eudoxos/vism/issues/new?title=issue%20at%20XIX.13&body=(in%20version%205e05fa4%20dated%202023-02-24)>`__ Another discerns mentality-materiality’s conditions by means of the round of kamma and the round of kamma-result in this way:
...
`§14 <https://github.com/eudoxos/vism/issues/new?title=issue%20at%20XIX.14&body=(in%20version%205e05fa4%20dated%202023-02-24)>`__ Herein, kamma is fourfold: to be experienced here and now, to be experienced on rebirth, to be experienced in some subsequent becoming, and lapsed kamma. [#2]_ 
...
`§15 <https://github.com/eudoxos/vism/issues/new?title=issue%20at%20XIX.15&body=(in%20version%205e05fa4%20dated%202023-02-24)>`__ Another fourfold classification of kamma is this: weighty, habitual, death-threshold, and kamma [stored up] by being performed. [#3]_ 
...
`§19 <https://github.com/eudoxos/vism/issues/new?title=issue%20at%20XIX.19&body=(in%20version%205e05fa4%20dated%202023-02-24)>`__ When he sees thus, he abandons all his uncertainty, that is to say, the sixteen kinds described in the way beginning, “Was I in the past?” [see §6].

7. No Doer Apart from Kamma and Result
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
...
`§20 <https://github.com/eudoxos/vism/issues/new?title=issue%20at%20XIX.20&body=(in%20version%205e05fa4%20dated%202023-02-24)>`__ Hence the Ancients said:
...
`§21 <https://github.com/eudoxos/vism/issues/new?title=issue%20at%20XIX.21&body=(in%20version%205e05fa4%20dated%202023-02-24)>`__ When he has discerned the conditions of mentality-materiality in this way by means of the round of kamma and the round of kamma-result, and has abandoned uncertainty about the three periods of time, then all past, future and present states are understood by him in accordance with death and rebirth-linking. This is his full-understanding of the known (see :ref:`XX.3 <XX.3>`).

.. _XIX.22:

`§22 <https://github.com/eudoxos/vism/issues/new?title=issue%20at%20XIX.22&body=(in%20version%205e05fa4%20dated%202023-02-24)>`__ He understands thus: “Aggregates produced in the past with kamma as condition ceased there too. But other aggregates are produced in this becoming with past kamma as their condition, although there is no single thing that has come over from the past becoming to this becoming. And aggregates produced in this becoming with kamma as their condition will cease. And in the future becoming other aggregates will be produced, although no single thing will go over from this becoming to the future becoming.
...
`§23 <https://github.com/eudoxos/vism/issues/new?title=issue%20at%20XIX.23&body=(in%20version%205e05fa4%20dated%202023-02-24)>`__ 
...
.. [#5] See the various meanings of “arisen” given in :ref:`XXII.81f. <XXII.81>`
...
.. [#6] “Because it is a speciality of the Buddha and because it is the province of the knowledge that is not shared by disciples (see  [Paṭis]_  *I 121f.*\  ), it is called ‘not shared by disciples.’ That is why only a part can be known; it cannot all be known because it is not the province of such knowledge” ( [Vism-mhṭ]_  *772*\  ).
